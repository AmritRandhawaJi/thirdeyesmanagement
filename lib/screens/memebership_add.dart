          ...
          Padding(
            ...
            child: Column(children: [
              const Padding(
                ...
                child: Text("Did you know?",style: TextStyle(color: Colors.black54,fontFamily: "Montserrat")),
              ),
              CupertinoButton(
                  ...
                  child:  const Row(
                      ...
                      style: TextStyle(
                          ...
                          fontSize: 18)),]),
                  onPressed: () {
                    Navigator.push(context, MaterialPageRoute(builder: (context) => const MembershipBenifits(),));
                  }),
